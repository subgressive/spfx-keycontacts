...
export default class KeyContacts extends React.Component<IKeyContactsProps, any> {
  ...
  private _getContacts() {
    ...
    var url = this.props.webUrl + "/_api/web/lists/GetByTitle('Contacts')/items?$top="+maxCount+"&$expand=Contact/Id&$select=Title,Contact/Id,Contact/EMail,Contact/FirstName,Contact/LastName,Contact/Title,Contact/WorkPhone,Contact/Department,Contact/JobTitle";
    console.log("url="+url);
    this._getSPData(url)
      .then(data => {
